        ...
        self.imgs = ko.computed(function () {
            ...
            self.tiles().forEach(function (tile) {
                _.each(tile.data, function (val, key) {
                    // knockout-mapping's toJS implementation dereferences its
                    // argument before checking its type, so null tile values
                    // throw while an otherwise valid resource report loads.
